...
function ExportForm() {
  ...
  useEffect(() => {
    const phoneDetailId = searchParams.get("phoneDetailId");

    if (phoneDetailId) {
      setIsLoadingPhoneDetail(true);
      getPhoneDetail(phoneDetailId)
        .then((phoneDetail) => {
          if (phoneDetail) {
            initializeFromPhoneDetail(phoneDetail);
          } else {
        ...
        .finally(() => {
          setIsLoadingPhoneDetail(false);
        });
    }
  }, [searchParams, initializeFromPhoneDetail]);
              ...
              <div className="mt-6 border-t border-zinc-200 pt-6 dark:border-zinc-800">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <BirthdayInputField
                    ...
                    onChange={(value) =>
                      setFormData({ customerBirthday: value })
                    }
                  />
